    ...
    return (
        <main className="flex flex-col justify-between p-5 space-y-2" id="projects">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8">
                    <a className="flex flex-col justify-between"href="https://javatrol.herokuapp.com">Emperor&apos;s Dish Restaurant<Image src="/placeholder.jpeg" height="125" width="125" alt="projects"/></a>
                    <a className="flex flex-col justify-between"href="https://javatrol.herokuapp.com">EVie - Charging Station Finder<Image src="/placeholder.jpeg" height="125" width="125" alt="projects"/></a>
                    <a className="flex flex-col justify-between"href="https://javatrol.herokuapp.com">Social Media API<Image src="/placeholder.jpeg" height="125" width="125" alt="projects"/></a>
                    <a className="flex flex-col justify-between"href="https://javatrol.herokuapp.com">E-Commerce Backend<Image src="/placeholder.jpeg" height="125" width="125" alt="projects"/></a>
                    <a className="flex flex-col justify-between"href="https://javatrol.herokuapp.com">Weather Dashboard<Image src="/placeholder.jpeg" height="125" width="125" alt="projects"/></a>
                    <a className="flex flex-col justify-between"href="https://javatrol.herokuapp.com">Team Profile Generator<Image src="/placeholder.jpeg" height="125" width="125" alt="projects"/></a>
                    <a className="flex flex-col justify-between"href="https://javatrol.herokuapp.com">Javascript Challenge<Image src="/placeholder.jpeg" height="125" width="125" alt="projects"/></a>
                    <a className="flex flex-col justify-between"href="https://javatrol.herokuapp.com">Password Generator<Image src="/placeholder.jpeg" height="125" width="125" alt="projects"/></a> 
                </div>    
        </main>
    )
